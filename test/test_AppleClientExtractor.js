...
var assert = require("assert"),
    ...
    AppleClientExtractor = require('../lib/email_clients/AppleClientExtractor'),
    test_common = require('./test_common');

describe("Apple Extractor", function()
{
    this.timeout(1000);
    var appleClient = new AppleClientExtractor();
    test_common.testMatch(appleClient);
    test_common.testExtract(appleClient);
});
