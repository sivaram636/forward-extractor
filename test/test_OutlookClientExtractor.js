 ...
 *
 * test_OutlookClientExtractor.js
 */
...
var assert = require("assert"),
    ...
    OutlookClientExtractor = require('../lib/email_clients/OutlookClientExtractor'),
    test_common = require('./test_common');

describe("Outlook Extractor", function ()
{
    this.timeout(1000);
    var outlookClient = new OutlookClientExtractor();
    test_common.testMatch(outlookClient);
    test_common.testExtract(outlookClient);
});
