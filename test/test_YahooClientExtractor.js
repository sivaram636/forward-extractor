...
var assert = require("assert"),
    ...
    YahooClientExtractor = require('../lib/email_clients/YahooClientExtractor'),
    test_common = require('./test_common');

describe("Yahoo Extractor", function()
{
    this.timeout(1000);
    var yahooClient = new YahooClientExtractor();
    test_common.testMatch(yahooClient);
    test_common.testExtract(yahooClient)
});
